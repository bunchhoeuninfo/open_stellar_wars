...
class EnemyNormalBullet extends PositionComponent with CollisionCallbacks {
   final double speed;
  final int damage;
  SpriteComponent bulletSprite;  // Sprite is now a component

  EnemyNormalBullet({required this.speed, required this.damage, required Vector2 position, required Sprite sprite})
