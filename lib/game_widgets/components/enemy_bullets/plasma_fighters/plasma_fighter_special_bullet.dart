...
class PlasmaFighterSpecialBullet extends PositionComponent with CollisionCallbacks {
  final double speed;
  final int damage;
  SpriteComponent bulletSprite;

  PlasmaFighterSpecialBullet({required this.speed, required this.damage, required Vector2 position, required Sprite sprite})
