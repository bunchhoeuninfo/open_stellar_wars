...
class FireBulletControlBtn extends StatelessWidget {
  FireBulletControlBtn({super.key, required this.game});
  ...
  GestureDetector _bottomJump() {
    return GestureDetector(
      onTap: () {
        LogUtil.debug('message: fire bullet button pressed');
        game.player.fire(isSpecial: false);
      },
      //child: const Icon(Icons., size: 50, color: Colors.amber,),
      child: const FaIcon(FontAwesomeIcons.gun, size: 50, color: Colors.amber,),
    );
  }
